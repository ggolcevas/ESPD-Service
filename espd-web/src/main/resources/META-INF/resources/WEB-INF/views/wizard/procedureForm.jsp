            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <form:radiobutton path="eoRegistered.answer" value="true" id="eo_registered_answer_yes"
                                              data-target-show="#reg-official-yes" data-target-hide="#reg-official-no"/>${span18n["yes"]}
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <form:radiobutton path="eoParticipatingProcurementProcedure.answer" value="true"
                                              data-target-show="#group-form"/>${span18n["yes"]}
                            <form:radiobutton path="eoParticipatingProcurementProcedure.answer" value="false"
                                              data-target-hide="#group-form"/>${span18n["no"]}
                        </div>
                    </div>
                </div>
                <div id="group-form"
    ...
    <c:forEach var="representative" items="${espd.economicOperator.representatives}" varStatus="vs">
        ...
        <div class="panel panel-espd">
            <div class="panel-heading clearfix" data-toggle="collapse"
                 data-target="#createeo_info_respresent_div${vs.index}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:input type="text"
                                                path="economicOperator.representatives[${vs.index}].dateOfBirth"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:textarea rows="1" cssClass="form-control"
                                                   path="economicOperator.representatives[${vs.index}].email"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:textarea rows="1" cssClass="form-control"
                                                   path="economicOperator.representatives[${vs.index}].phone"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:textarea rows="1" cssClass="form-control"
                                                   path="economicOperator.representatives[${vs.index}].position"/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="createeo_subcontractors" class="collapse in">
            <div class="panel-body">
                ...
                <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-6">
                        <form:radiobutton path="subcontractingThirdParties.answer" value="true"
                                          data-target-show="#createeo_subcontractors_div"/>${span18n["yes"]}
                        <form:radiobutton path="subcontractingThirdParties.answer" value="false"
                                          data-target-hide="#createeo_subcontractors_div"/>${span18n["no"]}
                    </div>
                </div>
                <div id="createeo_subcontractors_div"
                     class="${espd['subcontractingThirdParties'].answer ? '' : 'collapse'}">
                    <div class="col-md-12 form-group">
                        <label class="control-label col-md-6">${span18n['createeo_information_subcontractors_description']}</label>
                        <div class="col-md-6">
                            <form:textarea rows="1" cssClass="form-control"
                                           path="subcontractingThirdParties.description1"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 alert alert-espd-info-dotted">
